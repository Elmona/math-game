...
export default async function Home() {
  ...
  return (
    <main
      className="flex flex-1 flex-col items-center justify-center gap-10 px-6 py-16 bg-indigo-950 bg-cover bg-center bg-no-repeat text-white text-center"
      style={{ backgroundImage: "url('/background.png')" }}
    >
      <div className="flex flex-col items-center gap-10 w-full max-w-xs bg-black/35 backdrop-blur-sm rounded-3xl px-8 py-10">
