...
- [x] Step 3.3 — Game screen
- [x] Step 3.4 — Results screen
- [x] Step 3.5 — Leaderboard

## Phase 4 — Polish & deployment

- [x] Step 4.1 — Responsive design check
- [x] Step 4.2 — Vercel deployment setup
...
- **Next**: Step 4.1 — Responsive design check

### Step 3.3 — Game screen (2026-04-02)
- `/spela`: solo name entry → create player; team: reads URL params
- 60s timer, 20 questions, 3-wrong reveal mechanic, score submission
- WCAG: sr-only timer milestones, aria-live question, role=alert feedback, attempt dots
